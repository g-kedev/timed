    ...
    <ValidatedForm @on-submit={{perform this.save}} as |f|>
      <Card as |c|>
          ...
          <div class="grid gap-1">
            <f.input @name="notBillable" @labelComponent={{Void}}>
              <Checkbox
                ...
                @onChange={{fn (mut this.originalUpdatedReport.notBillable)}}
              >
                Not billable
              </Checkbox>
            </f.input>
        ...
        <div class="WIP-second-report">
          ...
          <label for="comment">
            Comment
            <ReportComment @onChange={{fn (mut this.secondReport.comment)}} />
          </label>
          <div class="grid gap-1">
            <f.input @name="notBillable" @labelComponent={{Void}}>
              <Checkbox

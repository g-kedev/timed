...
export default class SplitReportComponent extends Component {
  ...
  get isValidSplit() {
    if (!this.secondReport.task) return false;
    if (
      !this.secondReportDuration ||
      this.secondReportDuration.as("minutes") <= 0
    ) {
      return false;
    }
    if (!this.oldReportDuration || this.oldReportDuration.as("minutes") <= 0) {
      return false;
    }
    if (
      this.oldReportDuration.as("minutes") +
        this.secondReportDuration.as("minutes") !==
      this.totalDuration.as("minutes")
    ) {
      return false;
    }
    // TODO: ask if review comment is optional, if mandatory then make additional check to validate that comment is set
    return true;
  }
              ...
              <div class="flex flex-row gap-4">
                <div class="flex w-1/2 flex-col gap-2">
                  ...
                  >
                    ...
                    <t.task @dropdownClass="z-[60]" data-test-old-report-task />
                  </TaskSelection>
                  <label for="comment">
                    Comment
                    <ReportComment
                      data-test-old-report-comment
                  ...
                  <div class="grid gap-1">
                    <f.input @name="notBillable" @labelComponent={{Void}}>
                      <Checkbox
                        data-test-old-report-not-billable
                  ...
                  <Durationpicker
                    data-test-old-report-durationpicker
                    name="duration"
                ...
                <div class="flex w-1/2 flex-col gap-2">
                  ...
                  >
                    ...
                    <t.project
                      @dropdownClass="z-[60]"
                      data-test-second-report-project
                    />
                    <t.task
                      @dropdownClass="z-[60]"
                      data-test-second-report-task
                    />
                  </TaskSelection>
                  <label for="comment">
                    Comment
                    <ReportComment
                      data-test-second-report-comment
                  ...
                  <div class="grid gap-1">
                    <f.input @name="notBillable" @labelComponent={{Void}}>
                      <Checkbox
                        data-test-second-report-not-billable
                    ...
                    <f.input @name="review" @labelComponent={{Void}}>
                      <Checkbox
                        data-test-second-report-review
                  ...
                  <Durationpicker
                    data-test-second-report-durationpicker
                    name="duration"
                    @min={{this.durationpickerMin}}
                    @max={{this.durationpickerMax}}
              ...
              <div>
                <label for="comment">
                  ...
                  <ReportComment
                    ...
                    placeholder="Comment/Reason for split..."
            ...
            <c.footer>
              <div class="relative flex">
                ...
                <f.submit
                  ...
                  @disabled={{not this.isValidSplit}}
                />
              </div>
            </c.footer>
          </Card>

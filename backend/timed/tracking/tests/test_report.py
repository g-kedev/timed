...
def test_report_update_bulk_billed(
    ...
    """Test that reports are automatically marked as billed when bulk-moved to a billed project."""
    user = internal_employee_client.user
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # can verify none of them, since user isn't reviewer on any of the reports
